<h1 align="center">Hey, I'm Shlok Patel 👋</h1>
<h4 align="center">Computer Science & Business Administration: FinTech Honors student at Northeastern University</h4>
...
![](https://github-readme-stats-rho-navy.vercel.app/api?username=shlok-p07&limit=5&theme=radical&combine_all_yearly_contributions=true)

---
[![](https://visitcount.itsvg.in/api?id=shlok-p07&icon=0&color=0)](https://visitcount.itsvg.in)
...
**Oasis** — Boston, MA  
*Team Mentor (Project Series)* | Jan 2026 – Present  
- Guided students and peers in building projects over a six-week series, helping them design, develop, and deploy software applications.  
- Mentored teams of 5+ through technical challenges, project planning, and UI/UX design.  
- Demonstrated software development best practices using JavaScript, Node.js, React, and other modern tools.


**Rainfall Learning** — Boston, MA  
*Software Engineer (Interface Team)* | Nov 2025 – Present  
- Contributing to a large-scale project that helps middle school and high school programmers to learn on the Browser-based IDE and session interface design built with React and TypeScript for an engaging user interface
- Integrating collaborative UI architecture with other 15+ programmers to help establish a scalable structure for real-time updates, enabling faster rendering, more consistent editor behavior, and a foundation for future multi-user features


**Rutgers University** — New Brunswick, NJ  
*College Assistant (Math Department)* | Summers 2024, 2025  
- Monitored program activities of over 100+ people through maintaining up-to-date records of logistics and events ensuring a smooth management of the program using Excel for planning of daily schedules for the students
- Planned and executed for 4-6 weeks to focus on fostering relationships and educational relationships with students creating a supportive learning environment
- Enriched relationships with students and peers while teaching and learning: Linear Algebra, Group and Voting Theory
