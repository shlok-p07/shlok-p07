...
<h3 align="center">Computer Science & Business Administration: FinTech Honors student at Northeastern University</h3>
...
B.S. in Computer Science & Business Administration (FinTech Honors)  
📅 Graduation: May 2029 | GPA: 3.84/4.00  
**Relevant Coursework:** Discrete Structures, Program Design and Implementation, Financial Accounting & Reporting  
...
- Built browser-based IDEs and collaborative UI for middle and high school students using React & TypeScript.  
- Implemented scalable real-time updates for multi-user support.  

**Rutgers University** — New Brunswick, NJ  
*College Assistant (Math Department)* | Summers 2024, 2025  
- Managed activities for 100+ students; streamlined scheduling using Excel.  
- Taught Linear Algebra, Group and Voting Theory, fostering a supportive learning environment.  
